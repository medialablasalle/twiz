...
/*
 * Slave latency - range: 0 to ((connSupervisionTimeout / ConnInterval) - 1)
 */
#define SLAVE_LATENCY                   0 // TODO find max
/*
 * Connection supervisory timeout - shall be a multiple of 10 ms in the range of 100ms to 32s
 * shall be larger than (1 + connSlaveLatency) * connInterval.
 */
